...
if __name__ == '__main__':
    ...
    arch = (784, [64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64 , 10])
    ...
    # mnist_training_analysis_hook_engine(6, archirecture=arch, pre_path='sept_result_mnist_three_class', three_class=False, odd_even=False)
