...
if __name__ == '__main__':
    ...
    mnist_training_analysis_hook_engine(10, archirecture=arch, pre_path='sept_result_mnist_three_class', three_class=True, odd_even=False)
