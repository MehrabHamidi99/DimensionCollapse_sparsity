...
def kuji_mnist_training_analysis_hook_engine(try_num, archirecture=(784, [256, 128, 64, 64, 64, 64, 32, 10]), epochs=100, pre_path='', bias=1e-4, three_class=False, odd_even=False, debug=False):
...
def kuji_mnist_training_analysis_spike_loss(try_num, archirecture=(784, [256, 128, 64, 64, 64, 64, 32, 10]), epochs=100, pre_path='', bias=1e-4, three_class=False, odd_even=False, debug=False):
