...
def run_function(arch_set, dest='results/tests'):
    ...
    prod_x = partial(before_after_training_experiment, epochs=50, num=10000, one=False, pre_path=dest, normal_dist=normal_dist, loc=0, scale=scale)
...
if __name__ == '__main__':
    ...
    run_function(archs_1, 'results/training_analysis')
    print("Done")
