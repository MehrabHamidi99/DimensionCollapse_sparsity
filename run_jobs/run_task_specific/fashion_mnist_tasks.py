from Training.task_specifc import fashion_mnist_task
import time
...
if __name__ == '__main__':
    ...
    if parser['training_mode'] == 'normal':
        ...
        fashion_mnist_training_analysis_hook_engine(try_num, archirecture=arch, pre_path='november_res/fashion_mnist_normal', epochs=500, bias=bias)
    
    #####################

    if parser['training_mode'] == 'spike_loss':
        arch = (784, [128, 128, 128, 64, 64, 64, 64, 64, 64, 32, 10])
        fashion_mnist_training_spike_loss(try_num, archirecture=arch, pre_path='november_res/fahsion_mnist_spike_loss', epochs=500, bias=bias)
